## Android4Bikes
### About:
The application Android4Bikes is a project of the students at the [Technische Hochschule Ulm](https://studium.hs-ulm.de/en) in cooperation with [Elektrobit](https://www.elektrobit.com/). 
...
- [Luca Tonak](mailto:tonak@mail.hs-ulm.de)
- [Patrick Klingenberg](mailto:klingenberg@mail.hs-ulm.de)
