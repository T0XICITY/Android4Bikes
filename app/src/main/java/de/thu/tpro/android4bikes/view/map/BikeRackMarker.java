...
public class BikeRackMarker {
    ...
    public BikeRackMarker() {
    }

    public BikeRackMarker(LatLng latLng, String title, String snippet, MarkerOptions marker) {
        this.latLng = latLng;
        this.title = title;
    ...
    public MarkerOptions makeMarker() {
        ...
        MarkerOptions markerBR = new MarkerOptions()
                .position(latLng)
                .title(title)
                .snippet(snippet)
